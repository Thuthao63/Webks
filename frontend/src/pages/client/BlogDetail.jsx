...
import { Calendar, ArrowLeft, Clock, Share2, Facebook, Twitter, Link as LinkIcon } from 'lucide-react';
        ...
        <div className="min-h-screen bg-slate-50 pb-24">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex flex-col lg:flex-row gap-12 items-start">
                    ...
                    {/* Left Sidebar - Sharing (Hidden on mobile, sticky on desktop) */}
                    <div className="hidden lg:flex flex-col gap-6 sticky top-32 w-16 items-center shrink-0">
                        <div className="text-xs font-bold text-slate-400 uppercase tracking-widest writing-vertical-rl transform rotate-180 mb-4">{t('blogDetail.share')}</div>
                        <div className="w-px h-12 bg-slate-300 mb-2"></div>
                        <button className="w-10 h-10 rounded-full bg-white shadow-md flex items-center justify-center text-slate-500 hover:text-blue-600 hover:bg-blue-50 transition-all">
                            <Facebook size={18} />
                        </button>
                        <button className="w-10 h-10 rounded-full bg-white shadow-md flex items-center justify-center text-slate-500 hover:text-blue-400 hover:bg-blue-50 transition-all">
                            <Twitter size={18} />
                        </button>
                    ...
                    {/* Right Space to balance the layout on large screens */}
