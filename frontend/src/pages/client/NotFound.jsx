        ...
        <div className="min-h-screen bg-[#050505] text-white flex items-center justify-center px-6 overflow-hidden relative">
            ...
            <div className="max-w-2xl w-full text-center space-y-12 relative z-10">
                ...
                <div className="flex flex-col sm:flex-row items-center justify-center gap-6 pt-8">
                    <button 
                        onClick={() => navigate('/')}
                        className="w-full sm:w-auto px-12 py-5 bg-white text-black text-sm font-black uppercase tracking-wider rounded-full hover:bg-amber-500 transition-all flex items-center justify-center gap-3 shadow-2xl"
                    >
                        <Home size={16} /> Về trang chủ
                    </button>
                    <button 
                        onClick={() => navigate('/rooms')}
                        className="w-full sm:w-auto px-12 py-5 bg-white/5 border border-white/10 text-white text-sm font-black uppercase tracking-wider rounded-full hover:bg-white/10 transition-all flex items-center justify-center gap-3"
                    >
