            ...
            <div className="bg-white max-w-lg w-full p-10 md:p-16 rounded-[2.5rem] shadow-premium text-center">
                {status === 'processing' && (
                    <div className="flex flex-col items-center gap-6">
                        ...
                        <h2 className="text-2xl font-serif italic text-slate-900" style={{ fontFamily: "'Playfair Display', serif" }}>
                            Đang xử lý kết quả...
                        </h2>
                ...
                {status === 'success' && (
                    <div className="flex flex-col items-center gap-6 animate-in zoom-in-95 duration-500">
                        ...
                        <h2 className="text-3xl font-serif italic text-slate-900" style={{ fontFamily: "'Playfair Display', serif" }}>
