  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-cream flex flex-col items-center justify-center gap-8 relative overflow-hidden">
        ...
        <p className="text-amber-500 text-xs tracking-[0.15em] font-black uppercase animate-pulse relative z-10">Đang chuẩn bị dịch vụ</p>
      </div>
    );
  }
                ...
                >
                   ...
                   <div className="pt-10 mt-10 border-t border-slate-50 flex justify-between items-center text-right">
                       <div className="flex flex-col w-full">
                           <span className="text-sm uppercase tracking-widest text-slate-400 font-black mb-2 italic">Phí dịch vụ ưu đãi</span>
                           <span className="text-amber-500 font-serif italic text-3xl">
                              {Number(service.price).toLocaleString()} <span className="text-xs not-italic uppercase font-sans font-black tracking-widest text-slate-300 ml-2">VNĐ</span>
                           </span>
                       </div>
                   </div>
                </div>
      ...
      <section className="py-56 px-6 border-t border-slate-50 text-center relative overflow-hidden">
         ...
         <div className="relative z-10 max-w-4xl mx-auto space-y-12">
            <h2 className="text-4xl md:text-6xl font-serif italic text-slate-900" style={{ fontFamily: "'Playfair Display', serif" }}>
               Khám phá <span className="text-amber-500 not-italic font-bold">Thế giới Đặc quyền</span>
            </h2>
