  ...
  return (
    ...
    >
      <form onSubmit={handleReset} className="space-y-4">
        ...
        >
          <label className="text-[9px] uppercase tracking-widest text-amber-500/80 font-black ml-1">Mật khẩu mới</label>
        ...
        >
          {loading ? <Loader2 className="animate-spin" size={14} /> : <><Save size={14} /> Đổi mật khẩu</>}
        </motion.button>
      </form>
