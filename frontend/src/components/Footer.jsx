...
const Footer = () => {
  ...
  return (
    <footer className="bg-[#F9F8F6] text-slate-900 pt-20 pb-12 border-t border-slate-100">
          ...
          <div className="lg:col-span-3 space-y-6">
            ...
            <div className="relative group max-w-md">
              <input
                ...
                className="w-full bg-white border border-slate-200 rounded-md py-3 px-4 text-sm outline-none focus:border-[#B59A6D]/50 focus:ring-1 focus:ring-[#B59A6D]/20 transition-all text-slate-900 placeholder-slate-400"
              />
              <button className="absolute right-2 top-1/2 -translate-y-1/2 w-10 h-10 bg-[#B59A6D] rounded-md flex items-center justify-center text-white hover:opacity-90 transition-all">
                <Send size={18} />
              </button>
            </div>
          </div>
